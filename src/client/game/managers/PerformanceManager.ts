...
export class PerformanceManager {
  ...
  public setShowFps(show: boolean): void {
    if (show && !this.fpsUI) {
      this.fpsUI = AdvancedDynamicTexture.CreateFullscreenUI('PerformanceUI')
      ...
      this.fpsText.paddingBottom = '10px' // Position at bottom right
      this.fpsUI.addControl(this.fpsText)
      this.lastPerformanceUpdate = 0 // Reset timer to update immediately
  ...
  public setGraphicsQuality(quality: GraphicsQuality): void {
    ...
    switch (quality) {
      case 'low':
        ...
        this.scene.getEngine().setHardwareScalingLevel(2.0)
      ...
      case 'medium':
        ...
        this.scene.getEngine().setHardwareScalingLevel(1.5)
    ...
    this.shadowGenerator.normalBias = 0.3
