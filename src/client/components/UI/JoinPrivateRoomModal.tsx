      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-base-100 p-6 rounded-2xl shadow-xl w-full max-w-sm border border-secondary/30 relative"
          ...
          >
            ...
            <h3 className="text-2xl font-bold mb-4 text-center text-secondary flex items-center justify-center gap-2">
              <KeyRound size={24} /> Enter Password
            </h3>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    maxLength={20}
                    className="input input-bordered input-secondary w-full pl-8"
