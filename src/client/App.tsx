    ...
    return (
        ...
        >
            ...
            <span className="float-element" style={{top: '18%', left: '24%', animationDelay: '0s', fontSize: '2.5rem'}}>
              🌸
                ...
                <span className="float-element"
                      style={{top: '75%', left: '5%', animationDelay: '2.2s', fontSize: '1.8rem'}}>
              🍰
            </span>
                <span className="float-element"
                      style={{top: '20%', left: '86%', animationDelay: '1.1s', fontSize: '2.8rem'}}>
              ✨
            </span>
                <span className="float-element"
                      style={{top: '82%', left: '85%', animationDelay: '3.5s', fontSize: '1.7rem'}}>
              🌟
            </span>
                <span className="float-element"
                      style={{top: '50%', left: '16%', animationDelay: '0.5s', fontSize: '2rem'}}>
              💖
            </span>
                <span className="float-element"
                      style={{top: '5%', left: '40%', animationDelay: '4.0s', fontSize: '1.4rem'}}>
              ☁️
            </span>
                <span className="float-element"
                      style={{top: '50%', left: '70%', animationDelay: '1.8s', fontSize: '2.8rem'}}>
              🍓
            </span>
                <span className="float-element"
                      style={{top: '90%', left: '30%', animationDelay: '0.8s', fontSize: '2.2rem'}}>
              🍭
            </span>
                <span className="float-element"
                      style={{top: '87%', left: '66%', animationDelay: '5.0s', fontSize: '1.9rem'}}>
              🍙
            </span>
                <span className="float-element"
                      style={{top: '5%', left: '5%', animationDelay: '3.0s', fontSize: '2.1rem'}}>
              🎉
            </span>
                <span className="float-element"
                      style={{top: '45%', left: '95%', animationDelay: '2.8s', fontSize: '1.9rem'}}>
              🍩
            </span>
                <span className="float-element"
                      style={{top: '13%', left: '70%', animationDelay: '0.2s', fontSize: '2.4rem'}}>
              🎐
            </span>
            </AnimatePresence>
            ...
            >
                ...
                <p className="text-xs mt-4 text-base-content/60 flex items-center justify-center gap-1">
                ...
                {showInitialSetup ? (
                    ...
                    >
                        ...
                        >
                            ...
                            <button onClick={handleOpenSettings}
                                    className="btn-dream flex items-center justify-center gap-2">
                    ...
                    >
                        <div className="flex-1 bg-base-100 w-full h-full">
                            <Game onBackToMenu={handleBackToMenu} setGameEngineInstance={setGameEngineInstance}
