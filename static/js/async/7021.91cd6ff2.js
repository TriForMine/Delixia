"use strict";(self.webpackChunkdelixia=self.webpackChunkdelixia||[]).push([["7021"],{67017:function(e,i,n){var a=n(83477);let r="harmonicsFunctions",t=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t)},24453:function(e,i,n){var a=n(83477);let r="hdrFilteringFunctions",t=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t)},7122:function(e,i,n){var a=n(83477);let r="importanceSampling",t=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t)},77781:function(e,i,n){var a=n(83477);let r="pbrBRDFFunctions",t=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t),n(67968),n(35104);let o="pbrFragmentExtraDeclaration",f=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;a.v.IncludesShadersStore[o]||(a.v.IncludesShadersStore[o]=f),n(62e3),n(99158),n(74023);let l="samplerFragmentAlternateDeclaration",c=`#ifdef _DEFINENAME_
...
#endif
`;a.v.IncludesShadersStore[d]||(a.v.IncludesShadersStore[d]=s),n(32659),n(21529),n(81457),n(49594),n(2738);let E="subSurfaceScatteringFunctions",R=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;a.v.IncludesShadersStore[E]||(a.v.IncludesShadersStore[E]=R),n(7122);let C="pbrHelperFunctions",u=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;a.v.IncludesShadersStore[C]||(a.v.IncludesShadersStore[C]=u),n(20962),n(88037),n(67017),n(72216);let v="pbrDirectLightingSetupFunctions",S=`struct preLightingInfo
...
#endif
`;a.v.IncludesShadersStore[v]||(a.v.IncludesShadersStore[v]=S);let m="pbrDirectLightingFalloffFunctions",A=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;a.v.IncludesShadersStore[m]||(a.v.IncludesShadersStore[m]=A),n(77781),n(24453);let I="pbrDirectLightingFunctions",N=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
...
#endif
`;a.v.IncludesShadersStore[I]||(a.v.IncludesShadersStore[I]=N);let T="pbrIBLFunctions",p=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;a.v.IncludesShadersStore[T]||(a.v.IncludesShadersStore[T]=p),n(83894),n(15064),n(83206),n(80710);let O="pbrBlockAlbedoOpacity",L=`struct albedoOpacityOutParams
...
`;a.v.IncludesShadersStore[O]||(a.v.IncludesShadersStore[O]=L);let g="pbrBlockReflectivity",h=`struct reflectivityOutParams
...
`;a.v.IncludesShadersStore[g]||(a.v.IncludesShadersStore[g]=h);let _="pbrBlockAmbientOcclusion",M=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;a.v.IncludesShadersStore[_]||(a.v.IncludesShadersStore[_]=M);let D="pbrBlockAlphaFresnel",F=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;a.v.IncludesShadersStore[D]||(a.v.IncludesShadersStore[D]=F);let P="pbrBlockAnisotropic",b=`#ifdef ANISOTROPIC
...
#endif
`;a.v.IncludesShadersStore[P]||(a.v.IncludesShadersStore[P]=b);let U="pbrBlockReflection",B=`#ifdef REFLECTION
...
#endif
`;a.v.IncludesShadersStore[U]||(a.v.IncludesShadersStore[U]=B);let G="pbrBlockSheen",y=`#ifdef SHEEN
...
#endif
`;a.v.IncludesShadersStore[G]||(a.v.IncludesShadersStore[G]=y);let V="pbrBlockClearcoat",H=`struct clearcoatOutParams
...
return outParams;}
#endif
`;a.v.IncludesShadersStore[V]||(a.v.IncludesShadersStore[V]=H);let x="pbrBlockIridescence",X=`struct iridescenceOutParams
...
#endif
`;a.v.IncludesShadersStore[x]||(a.v.IncludesShadersStore[x]=X);let W="pbrBlockSubSurface",k=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;a.v.IncludesShadersStore[W]||(a.v.IncludesShadersStore[W]=k),n(11977);let Y="pbrBlockNormalGeometric",w=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;a.v.IncludesShadersStore[Y]||(a.v.IncludesShadersStore[Y]=w),n(66205);let z="pbrBlockNormalFinal",K=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;a.v.IncludesShadersStore[z]||(a.v.IncludesShadersStore[z]=K),n(51112);let q="pbrBlockLightmapInit",Z=`#ifdef LIGHTMAP
...
#endif
`;a.v.IncludesShadersStore[q]||(a.v.IncludesShadersStore[q]=Z);let J="pbrBlockGeometryInfo",j=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;a.v.IncludesShadersStore[J]||(a.v.IncludesShadersStore[J]=j);let Q="pbrBlockReflectance0",$=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);vec3 specularEnvironmentR0=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;a.v.IncludesShadersStore[Q]||(a.v.IncludesShadersStore[Q]=$);let ee="pbrBlockReflectance",ei=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;a.v.IncludesShadersStore[ee]||(a.v.IncludesShadersStore[ee]=ei);let en="pbrBlockDirectLighting",ea=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;a.v.IncludesShadersStore[en]||(a.v.IncludesShadersStore[en]=ea),n(10450);let er="pbrBlockFinalLitComponents",et=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
#endif
#endif
`;a.v.IncludesShadersStore[er]||(a.v.IncludesShadersStore[er]=et);let eo="pbrBlockFinalUnlitComponents",ef=`vec3 finalDiffuse=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;a.v.IncludesShadersStore[eo]||(a.v.IncludesShadersStore[eo]=ef);let el="pbrBlockFinalColorComposition",ec=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;a.v.IncludesShadersStore[el]||(a.v.IncludesShadersStore[el]=ec),n(77388),n(87225);let ed="pbrBlockImageProcessing",es=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;a.v.IncludesShadersStore[ed]||(a.v.IncludesShadersStore[ed]=es);let eE="pbrBlockPrePass",eR=`float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
#endif
`;a.v.IncludesShadersStore[eE]||(a.v.IncludesShadersStore[eE]=eR),n(85422);let eC="pbrDebug",eu=`#if DEBUGMODE>0
...
#endif
`;a.v.IncludesShadersStore[eC]||(a.v.IncludesShadersStore[eC]=eu);let ev="pbrPixelShader",eS=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;a.v.ShadersStore[ev]||(a.v.ShadersStore[ev]=eS);let em={name:ev,shader:eS}}}]);