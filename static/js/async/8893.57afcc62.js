"use strict";(self.webpackChunkdelixia=self.webpackChunkdelixia||[]).push([["8893"],{24453:function(e,t,a){var o=a(83477);let i="hdrFilteringFunctions",n=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;o.v.IncludesShadersStore[i]||(o.v.IncludesShadersStore[i]=n)},7122:function(e,t,a){var o=a(83477);let i="importanceSampling",n=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;o.v.IncludesShadersStore[i]||(o.v.IncludesShadersStore[i]=n)},77781:function(e,t,a){var o=a(83477);let i="pbrBRDFFunctions",n=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
`;o.v.IncludesShadersStore[i]||(o.v.IncludesShadersStore[i]=n)},66115:function(e,t,a){a.r(t),a.d(t,{hdrFilteringPixelShader:()=>r});var o=a(83477);a(2738),a(7122),a(77781),a(24453);let i="hdrFilteringPixelShader",n=`#include<helperFunctions>
#include<importanceSampling>
#include<pbrBRDFFunctions>
#include<hdrFilteringFunctions>
uniform float alphaG;uniform samplerCube inputTexture;uniform vec2 vFilteringInfo;uniform float hdrScale;varying vec3 direction;void main() {vec3 color=radiance(alphaG,inputTexture,direction,vFilteringInfo);gl_FragColor=vec4(color*hdrScale,1.0);}`;o.v.ShadersStore[i]||(o.v.ShadersStore[i]=n);let r={name:i,shader:n}}}]);