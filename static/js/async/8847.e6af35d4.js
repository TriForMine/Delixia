"use strict";(self.webpackChunkdelixia=self.webpackChunkdelixia||[]).push([["8847"],{87559:function(e,r,f){var a=f(83477);let t="hdrFilteringFunctions",n=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
`;a.v.IncludesShadersStoreWGSL[t]||(a.v.IncludesShadersStoreWGSL[t]=n)},12968:function(e,r,f){f.r(r),f.d(r,{hdrIrradianceFilteringPixelShaderWGSL:()=>i});var a=f(83477);f(24086),f(45466),f(64913),f(87559);let t="hdrIrradianceFilteringPixelShader",n=`#include<helperFunctions>
...
#endif
);fragmentOutputs.color= vec4f(color*uniforms.hdrScale,1.0);}`;a.v.ShadersStoreWGSL[t]||(a.v.ShadersStoreWGSL[t]=n);let i={name:t,shader:n}}}]);