"use strict";(self.webpackChunkdelixia=self.webpackChunkdelixia||[]).push([["9608"],{44965:function(e,r,i){i.r(r),i.d(r,{iblCdfyPixelShaderWGSL:()=>n});var f=i(83477);let t="iblCdfyPixelShader",c=`varying vUV : vec2f;
...
fragmentOutputs.color= vec4f(cdfy,0.0,0.0,1.0);}`;f.v.ShadersStoreWGSL[t]||(f.v.ShadersStoreWGSL[t]=c);let n={name:t,shader:c}}}]);