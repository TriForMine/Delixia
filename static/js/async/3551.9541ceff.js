"use strict";(self.webpackChunkdelixia=self.webpackChunkdelixia||[]).push([["3551"],{87559:function(e,r,f){var a=f(83477);let t="hdrFilteringFunctions",n=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
`;a.v.IncludesShadersStoreWGSL[t]||(a.v.IncludesShadersStoreWGSL[t]=n)},14199:function(e,r,f){f.r(r),f.d(r,{hdrFilteringPixelShaderWGSL:()=>i});var a=f(83477);f(24086),f(45466),f(64913),f(87559);let t="hdrFilteringPixelShader",n=`#include<helperFunctions>
#include<importanceSampling>
#include<pbrBRDFFunctions>
#include<hdrFilteringFunctions>
uniform alphaG: f32;var inputTextureSampler: sampler;var inputTexture: texture_cube<f32>;uniform vFilteringInfo: vec2f;uniform hdrScale: f32;varying direction: vec3f;@fragment
fn main(input: FragmentInputs)->FragmentOutputs {var color: vec3f=radiance(uniforms.alphaG,inputTexture,inputTextureSampler,input.direction,uniforms.vFilteringInfo);fragmentOutputs.color= vec4f(color*uniforms.hdrScale,1.0);}`;a.v.ShadersStoreWGSL[t]||(a.v.ShadersStoreWGSL[t]=n);let i={name:t,shader:n}}}]);