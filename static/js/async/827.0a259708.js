"use strict";(self.webpackChunkdelixia=self.webpackChunkdelixia||[]).push([["827"],{96166:function(e,a,r){var t=r(83477);let i="packingFunctions",f=`fn pack(depth: f32)->vec4f
{const bit_shift: vec4f= vec4f(255.0*255.0*255.0,255.0*255.0,255.0,1.0);const bit_mask: vec4f= vec4f(0.0,1.0/255.0,1.0/255.0,1.0/255.0);var res: vec4f=fract(depth*bit_shift);res-=res.xxyz*bit_mask;return res;}
fn unpack(color: vec4f)->f32
{const bit_shift: vec4f= vec4f(1.0/(255.0*255.0*255.0),1.0/(255.0*255.0),1.0/255.0,1.0);return dot(color,bit_shift);}`;t.v.IncludesShadersStoreWGSL[i]||(t.v.IncludesShadersStoreWGSL[i]=f)},65022:function(e,a,r){r.r(a),r.d(a,{shadowMapPixelShaderWGSL:()=>c});var t=r(83477);r(96166);let i="bayerDitherFunctions",f=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;t.v.IncludesShadersStoreWGSL[i]||(t.v.IncludesShadersStoreWGSL[i]=f);let n="shadowMapFragmentExtraDeclaration",S=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;t.v.IncludesShadersStoreWGSL[n]||(t.v.IncludesShadersStoreWGSL[n]=S),r(92094),r(15793);let s="shadowMapFragment",d=`var depthSM: f32=fragmentInputs.vDepthMetricSM;
#if defined(SM_DEPTHCLAMP) && SM_DEPTHCLAMP==1
#if SM_USEDISTANCE==1
...
#endif
`;t.v.IncludesShadersStoreWGSL[s]||(t.v.IncludesShadersStoreWGSL[s]=d);let p="shadowMapPixelShader",o=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;t.v.ShadersStoreWGSL[p]||(t.v.ShadersStoreWGSL[p]=o);let c={name:p,shader:o}}}]);