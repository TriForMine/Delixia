"use strict";(self.webpackChunkdelixia=self.webpackChunkdelixia||[]).push([["2698"],{16197:function(e,r,f){f.r(r),f.d(r,{iblCdfDebugPixelShaderWGSL:()=>u});var c=f(83477);let i="iblCdfDebugPixelShader",t=`#define PI 3.1415927
...
fragmentOutputs.color =vec4(mix(colour,backgroundColour,0.5),1.0);}`;c.v.ShadersStoreWGSL[i]||(c.v.ShadersStoreWGSL[i]=t);let u={name:i,shader:t}}}]);