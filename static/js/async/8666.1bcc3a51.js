"use strict";(self.webpackChunkdelixia=self.webpackChunkdelixia||[]).push([["8666"],{59358:function(e,t,r){r.r(t),r.d(t,{iblIcdfPixelShaderWGSL:()=>u});var a=r(83477);r(24086);let i="iblIcdfPixelShader",c=`#include<helperFunctions>
varying vUV: vec2f;
...
.r;var pixelLuminance: f32=fetchLuminance(input.vUV);outputColor.z=pixelLuminance/(2.0*PI*normalization);fragmentOutputs.color=vec4( outputColor,1.0);}`;a.v.ShadersStoreWGSL[i]||(a.v.ShadersStoreWGSL[i]=c);let u={name:i,shader:c}}}]);