"use strict";(self.webpackChunkdelixia=self.webpackChunkdelixia||[]).push([["8388"],{68722:function(e,r,i){var a=i(83477);let n="harmonicsFunctions",f=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;a.v.IncludesShadersStoreWGSL[n]||(a.v.IncludesShadersStoreWGSL[n]=f)},87559:function(e,r,i){var a=i(83477);let n="hdrFilteringFunctions",f=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;a.v.IncludesShadersStoreWGSL[n]||(a.v.IncludesShadersStoreWGSL[n]=f)},45466:function(e,r,i){var a=i(83477);let n="importanceSampling",f=`fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
fn hemisphereImportanceSampleDggx(u: vec2f,a: f32)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
fn hemisphereImportanceSampleDCharlie(u: vec2f,a: f32)->vec3f { 
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;a.v.IncludesShadersStoreWGSL[n]||(a.v.IncludesShadersStoreWGSL[n]=f)},64913:function(e,r,i){var a=i(83477);let n="pbrBRDFFunctions",f=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
`;a.v.IncludesShadersStoreWGSL[n]||(a.v.IncludesShadersStoreWGSL[n]=f),i(39471),i(70898);let t="samplerFragmentAlternateDeclaration",o=`#ifdef _DEFINENAME_
...
#endif
#endif
`;a.v.IncludesShadersStoreWGSL[t]||(a.v.IncludesShadersStoreWGSL[t]=o);let c="pbrFragmentSamplersDeclaration",l=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;a.v.IncludesShadersStoreWGSL[c]||(a.v.IncludesShadersStoreWGSL[c]=l),i(50574),i(92094),i(41127),i(78280),i(24086);let d="subSurfaceScatteringFunctions",s=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;a.v.IncludesShadersStoreWGSL[d]||(a.v.IncludesShadersStoreWGSL[d]=s),i(45466);let E="pbrHelperFunctions",v=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;a.v.IncludesShadersStoreWGSL[E]||(a.v.IncludesShadersStoreWGSL[E]=v),i(69196),i(27557),i(68722),i(41379);let m="pbrDirectLightingSetupFunctions",S=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;a.v.IncludesShadersStoreWGSL[m]||(a.v.IncludesShadersStoreWGSL[m]=S);let u="pbrDirectLightingFalloffFunctions",R=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;a.v.IncludesShadersStoreWGSL[u]||(a.v.IncludesShadersStoreWGSL[u]=R),i(64913),i(87559);let p="pbrDirectLightingFunctions",C=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
...
#endif
`;a.v.IncludesShadersStoreWGSL[p]||(a.v.IncludesShadersStoreWGSL[p]=C);let A="pbrIBLFunctions",I=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;a.v.IncludesShadersStoreWGSL[A]||(a.v.IncludesShadersStoreWGSL[A]=I),i(94137),i(86156),i(46840),i(44636);let N="pbrBlockAlbedoOpacity",O=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;a.v.IncludesShadersStoreWGSL[N]||(a.v.IncludesShadersStoreWGSL[N]=O);let L="pbrBlockReflectivity",T=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;a.v.IncludesShadersStoreWGSL[L]||(a.v.IncludesShadersStoreWGSL[L]=T);let h="pbrBlockAmbientOcclusion",g=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;a.v.IncludesShadersStoreWGSL[h]||(a.v.IncludesShadersStoreWGSL[h]=g);let M="pbrBlockAlphaFresnel",_=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;a.v.IncludesShadersStoreWGSL[M]||(a.v.IncludesShadersStoreWGSL[M]=_);let D="pbrBlockAnisotropic",F=`#ifdef ANISOTROPIC
...
#endif
`;a.v.IncludesShadersStoreWGSL[D]||(a.v.IncludesShadersStoreWGSL[D]=F);let P="pbrBlockReflection",U=`#ifdef REFLECTION
...
#endif
`;a.v.IncludesShadersStoreWGSL[P]||(a.v.IncludesShadersStoreWGSL[P]=U);let b="pbrBlockSheen",G=`#ifdef SHEEN
...
#endif
`;a.v.IncludesShadersStoreWGSL[b]||(a.v.IncludesShadersStoreWGSL[b]=G);let B="pbrBlockClearcoat",y=`struct clearcoatOutParams
...
return outParams;}
#endif
`;a.v.IncludesShadersStoreWGSL[B]||(a.v.IncludesShadersStoreWGSL[B]=y);let x="pbrBlockIridescence",V=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;a.v.IncludesShadersStoreWGSL[x]||(a.v.IncludesShadersStoreWGSL[x]=V);let H="pbrBlockSubSurface",W=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;a.v.IncludesShadersStoreWGSL[H]||(a.v.IncludesShadersStoreWGSL[H]=W),i(15793);let X="pbrBlockNormalGeometric",k=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;a.v.IncludesShadersStoreWGSL[X]||(a.v.IncludesShadersStoreWGSL[X]=k),i(39749);let w="pbrBlockNormalFinal",Y=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;a.v.IncludesShadersStoreWGSL[w]||(a.v.IncludesShadersStoreWGSL[w]=Y),i(93226);let z="pbrBlockLightmapInit",K=`#ifdef LIGHTMAP
...
#endif
`;a.v.IncludesShadersStoreWGSL[z]||(a.v.IncludesShadersStoreWGSL[z]=K);let q="pbrBlockGeometryInfo",Z=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
`;a.v.IncludesShadersStoreWGSL[J]||(a.v.IncludesShadersStoreWGSL[J]=j);let Q="pbrBlockReflectance",$=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;a.v.IncludesShadersStoreWGSL[Q]||(a.v.IncludesShadersStoreWGSL[Q]=$);let ee="pbrBlockDirectLighting",er=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;a.v.IncludesShadersStoreWGSL[ee]||(a.v.IncludesShadersStoreWGSL[ee]=er),i(66020);let ei="pbrBlockFinalLitComponents",ea=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
#endif
#endif
`;a.v.IncludesShadersStoreWGSL[ei]||(a.v.IncludesShadersStoreWGSL[ei]=ea);let en="pbrBlockFinalUnlitComponents",ef=`var finalDiffuse: vec3f=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;a.v.IncludesShadersStoreWGSL[en]||(a.v.IncludesShadersStoreWGSL[en]=ef);let et="pbrBlockFinalColorComposition",eo=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;a.v.IncludesShadersStoreWGSL[et]||(a.v.IncludesShadersStoreWGSL[et]=eo),i(57350),i(52330);let ec="pbrBlockImageProcessing",el=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;a.v.IncludesShadersStoreWGSL[ec]||(a.v.IncludesShadersStoreWGSL[ec]=el);let ed="pbrBlockPrePass",es=`var writeGeometryInfo: f32=select(0.0,1.0,finalColor.a>ALPHATESTVALUE);var fragData: array<vec4<f32>,SCENE_MRT_COUNT>;
...
#endif
`;a.v.IncludesShadersStoreWGSL[ed]||(a.v.IncludesShadersStoreWGSL[ed]=es),i(45604);let eE="pbrDebug",ev=`#if DEBUGMODE>0
...
#endif
`;a.v.IncludesShadersStoreWGSL[eE]||(a.v.IncludesShadersStoreWGSL[eE]=ev);let em="pbrPixelShader",eS=`#define CUSTOM_FRAGMENT_BEGIN
...
`;a.v.ShadersStoreWGSL[em]||(a.v.ShadersStoreWGSL[em]=eS);let eu={name:em,shader:eS}}}]);