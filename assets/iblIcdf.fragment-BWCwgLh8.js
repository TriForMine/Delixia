import{S as r}from"./index-CYAGRGMs.js";const e="iblIcdfPixelShader",t=`#include<helperFunctions>
varying vUV: vec2f;
...
.r;var pixelLuminance: f32=fetchLuminance(input.vUV);outputColor.z=pixelLuminance/(2.0*PI*normalization);fragmentOutputs.color=vec4( outputColor,1.0);}`;r.ShadersStoreWGSL[e]||(r.ShadersStoreWGSL[e]=t);const i={name:e,shader:t};export{i as iblIcdfPixelShaderWGSL};
