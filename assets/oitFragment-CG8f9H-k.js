import{S as e}from"./index-DE-S9iIr.js";const o="decalFragmentDeclaration",S=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=S);const t="prePassDeclaration",g=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=g);const i="oitDeclaration",w=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=w);const a="lightFragmentDeclaration",X=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=X);const r="lightUboDeclaration",D=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=x);const n="shadowsFragmentFunctions",L=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=L);const l="samplerFragmentDeclaration",C=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=C);const d="reflectionFunction",E=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=E);const f="bumpFragmentMainFunctions",T=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=T);const h="bumpFragmentFunctions",I=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=I);const c="bumpFragment",A=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=A);const v="decalFragment",P=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=P);const p="depthPrePass",F=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=F);const u="lightFragment",M=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=M);const m="oitFragment",y=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=y);
