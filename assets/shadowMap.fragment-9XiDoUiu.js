import{g as e}from"./index-S6l8SMkQ.js";import"./packingFunctions-D4I0HVR4.js";const t="bayerDitherFunctions",n=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;e.IncludesShadersStoreWGSL[t]=n;const i="shadowMapFragmentExtraDeclaration",f=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;e.IncludesShadersStoreWGSL[i]=f;const S="shadowMapFragment",s=`var depthSM: f32=fragmentInputs.vDepthMetricSM;
#if defined(SM_DEPTHCLAMP) && SM_DEPTHCLAMP==1
#if SM_USEDISTANCE==1
...
#endif
`;e.IncludesShadersStoreWGSL[S]=s;const a="shadowMapPixelShader",r=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;e.ShadersStoreWGSL[a]=r;const p={name:a,shader:r};export{p as shadowMapPixelShaderWGSL};
