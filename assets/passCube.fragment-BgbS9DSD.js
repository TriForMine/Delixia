import{g as r}from"./index-oz25ygLZ.js";const e="passCubePixelShader",t=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_cube<f32>;
...
fragmentOutputs.color=textureSample(textureSampler,textureSamplerSampler,vec3f(uv,-1.001));
#endif
}`;r.ShadersStoreWGSL[e]=t;const a={name:e,shader:t};export{a as passCubePixelShaderWGSL};
