import{S as r}from"./index-Da7UxN6R.js";const e="iblCdfxPixelShader",i=`precision highp sampler2D;
#define PI 3.1415927
...
gl_FragColor=vec4(vec3(cdfx),1.0);}`;r.ShadersStore[e]||(r.ShadersStore[e]=i);const d={name:e,shader:i};export{d as iblCdfxPixelShader};
