import{g as e}from"./index-oz25ygLZ.js";import"./oitFragment-BGk6JdoJ.js";import"./harmonicsFunctions-qgfhuzO0.js";import"./mainUVVaryingDeclaration-CQ74aulV.js";import"./imageProcessingFunctions-DayoGJs4.js";import"./hdrFilteringFunctions-C4F3FLFp.js";const a="pbrFragmentDeclaration",r=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[a]=r;const o="pbrFragmentExtraDeclaration",t=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;e.IncludesShadersStore[o]=t;const f="samplerFragmentAlternateDeclaration",c=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[f]=c;const l="pbrFragmentSamplersDeclaration",d=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[l]=d;const s="subSurfaceScatteringFunctions",E=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[s]=E;const R="pbrHelperFunctions",C=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[R]=C;const A="pbrDirectLightingSetupFunctions",u=`struct preLightingInfo
...
#endif
`;e.IncludesShadersStore[A]=u;const m="pbrDirectLightingFalloffFunctions",S=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[m]=S;const I="pbrDirectLightingFunctions",v=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
...
#endif
`;e.IncludesShadersStore[I]=v;const O="pbrIBLFunctions",N=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[O]=N;const T="pbrBlockAlbedoOpacity",p=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[T]=p;const L="pbrBlockReflectivity",g=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[L]=g;const D="pbrBlockAmbientOcclusion",M=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[D]=M;const _="pbrBlockAlphaFresnel",h=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[_]=h;const F="pbrBlockAnisotropic",P=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[F]=P;const U="pbrBlockReflection",b=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[U]=b;const B="pbrBlockSheen",G=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[B]=G;const y="pbrBlockClearcoat",V=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[y]=V;const H="pbrBlockIridescence",x=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[H]=x;const W="pbrBlockSubSurface",X=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[W]=X;const k="pbrBlockNormalGeometric",Y=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[k]=Y;const w="pbrBlockNormalFinal",z=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStore[w]=z;const K="pbrBlockLightmapInit",$=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[K]=$;const q="pbrBlockGeometryInfo",Z=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[q]=Z;const J="pbrBlockReflectance0",j=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);vec3 specularEnvironmentR0=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;e.IncludesShadersStore[J]=j;const Q="pbrBlockReflectance",ee=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[Q]=ee;const ie="pbrBlockDirectLighting",ne=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStore[ie]=ne;const ae="pbrBlockFinalLitComponents",re=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[ae]=re;const oe="pbrBlockFinalUnlitComponents",te=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo.rgb;finalDiffuse=max(finalDiffuse,0.0);finalDiffuse*=vLightingIntensity.x;vec3 finalAmbient=vAmbientColor;finalAmbient*=surfaceAlbedo.rgb;vec3 finalEmissive=vEmissiveColor;
#ifdef EMISSIVE
...
`;e.IncludesShadersStore[oe]=te;const fe="pbrBlockFinalColorComposition",ce=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[fe]=ce;const le="pbrBlockImageProcessing",de=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[le]=de;const se="pbrBlockPrePass",Ee=`float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
#endif
`;e.IncludesShadersStore[se]=Ee;const Re="pbrDebug",Ce=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[Re]=Ce;const i="pbrPixelShader",n=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[i]=n;const Oe={name:i,shader:n};export{Oe as pbrPixelShader};
