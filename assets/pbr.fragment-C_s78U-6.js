import{g as e}from"./index-oz25ygLZ.js";import"./oitFragment-DQh1OrbS.js";import"./harmonicsFunctions-ColgEo-e.js";import"./mainUVVaryingDeclaration-C2KG8flv.js";import"./imageProcessingFunctions-DiT7verL.js";import"./hdrFilteringFunctions-DVAcsIko.js";const a="pbrFragmentExtraDeclaration",n=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[a]=n;const f="samplerFragmentAlternateDeclaration",t=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[f]=t;const o="pbrFragmentSamplersDeclaration",c=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[o]=c;const l="subSurfaceScatteringFunctions",d=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;e.IncludesShadersStoreWGSL[l]=d;const s="pbrHelperFunctions",E=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[s]=E;const m="pbrDirectLightingSetupFunctions",R=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[m]=R;const S="pbrDirectLightingFalloffFunctions",v=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;e.IncludesShadersStoreWGSL[S]=v;const u="pbrDirectLightingFunctions",C=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[u]=C;const p="pbrIBLFunctions",A=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[p]=A;const I="pbrBlockAlbedoOpacity",O=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[I]=O;const N="pbrBlockReflectivity",T=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[N]=T;const L="pbrBlockAmbientOcclusion",M=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[L]=M;const g="pbrBlockAlphaFresnel",D=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[g]=D;const _="pbrBlockAnisotropic",h=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[_]=h;const F="pbrBlockReflection",P=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[F]=P;const U="pbrBlockSheen",b=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[U]=b;const B="pbrBlockClearcoat",G=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[B]=G;const y="pbrBlockIridescence",V=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[y]=V;const x="pbrBlockSubSurface",H=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[x]=H;const W="pbrBlockNormalGeometric",X=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[W]=X;const k="pbrBlockNormalFinal",w=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[k]=w;const Y="pbrBlockLightmapInit",z=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[Y]=z;const K="pbrBlockGeometryInfo",$=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[K]=$;const q="pbrBlockReflectance0",Z=`var reflectance: f32=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);var specularEnvironmentR0: vec3f=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;e.IncludesShadersStoreWGSL[q]=Z;const j="pbrBlockReflectance",J=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[j]=J;const Q="pbrBlockDirectLighting",ee=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStoreWGSL[Q]=ee;const ie="pbrBlockFinalLitComponents",re=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[ie]=re;const ae="pbrBlockFinalUnlitComponents",ne=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo.rgb;finalDiffuse=max(finalDiffuse,vec3f(0.0));finalDiffuse*=uniforms.vLightingIntensity.x;var finalAmbient: vec3f=uniforms.vAmbientColor;finalAmbient*=surfaceAlbedo.rgb;var finalEmissive: vec3f=uniforms.vEmissiveColor;
#ifdef EMISSIVE
...
`;e.IncludesShadersStoreWGSL[ae]=ne;const fe="pbrBlockFinalColorComposition",te=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[fe]=te;const oe="pbrBlockImageProcessing",ce=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[oe]=ce;const le="pbrBlockPrePass",de=`var writeGeometryInfo: f32=select(0.0,1.0,finalColor.a>ALPHATESTVALUE);var fragData: array<vec4<f32>,SCENE_MRT_COUNT>;
...
#endif
`;e.IncludesShadersStoreWGSL[le]=de;const se="pbrDebug",Ee=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[se]=Ee;const i="pbrPixelShader",r=`#define CUSTOM_FRAGMENT_BEGIN
...
`;e.ShadersStoreWGSL[i]=r;const pe={name:i,shader:r};export{pe as pbrPixelShaderWGSL};
