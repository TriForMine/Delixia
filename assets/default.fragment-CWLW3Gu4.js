import{g as e}from"./index-oz25ygLZ.js";import"./oitFragment-BGk6JdoJ.js";import"./defaultUboDeclaration-BniSLsQC.js";import"./mainUVVaryingDeclaration-CQ74aulV.js";import"./imageProcessingFunctions-DayoGJs4.js";const r="defaultFragmentDeclaration",f=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[r]=f;const n="lightsFragmentFunctions",t=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
#endif
`;e.IncludesShadersStore[n]=t;const l="fresnelFunction",a=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[l]=a;const i="defaultPixelShader",o=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[i]=o;const u={name:i,shader:o};export{u as defaultPixelShader};
