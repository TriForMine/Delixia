import{S as e}from"./index-DE-S9iIr.js";import"./packingFunctions-B2OhYswe.js";const r="bayerDitherFunctions",f=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
}`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=i);const p={name:a,shader:i};export{p as shadowMapPixelShaderWGSL};
