...
#endif
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=le);const h="pbrBlockFinalUnlitComponents",de=`vec3 finalDiffuse=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=B);const Oe={name:i,shader:B};export{Oe as pbrPixelShader};
