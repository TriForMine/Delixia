import{S as e}from"./index-BAyO5ncN.js";import"./oitFragment-BvuOIU_Y.js";import"./harmonicsFunctions-CnU-wCR1.js";import"./mainUVVaryingDeclaration-D5rM_290.js";import"./imageProcessingFunctions-N5Rbp6RH.js";import"./hdrFilteringFunctions-BHe1NHPx.js";const r="pbrFragmentExtraDeclaration",b=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=X);const d="pbrIBLFunctions",k=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=k);const s="pbrBlockAlbedoOpacity",w=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=w);const E="pbrBlockReflectivity",Y=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=Y);const m="pbrBlockAmbientOcclusion",z=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=ee);const O="pbrBlockNormalFinal",ie=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=ie);const N="pbrBlockLightmapInit",re=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=re);const T="pbrBlockGeometryInfo",ae=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=oe);const h="pbrBlockFinalUnlitComponents",ce=`var finalDiffuse: vec3f=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=G);const pe={name:i,shader:G};export{pe as pbrPixelShaderWGSL};
