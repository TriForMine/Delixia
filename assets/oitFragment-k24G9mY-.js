import{g as e}from"./index-S6l8SMkQ.js";const o="decalFragmentDeclaration",t=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[o]=t;const i="prePassDeclaration",a=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[i]=a;const r="oitDeclaration",s=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[r]=s;const n="lightFragmentDeclaration",l=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[n]=l;const d="lightUboDeclaration",f=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[h]=c;const v="shadowsFragmentFunctions",p=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[v]=p;const u="samplerFragmentDeclaration",m=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[u]=m;const S="reflectionFunction",g=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[S]=g;const w="bumpFragmentMainFunctions",X=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[w]=X;const D="bumpFragmentFunctions",x=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[D]=x;const L="bumpFragment",C=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[L]=C;const E="decalFragment",T=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[E]=T;const I="depthPrePass",A=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[I]=A;const P="lightFragment",F=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[P]=F;const M="oitFragment",y=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
